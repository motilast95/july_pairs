...
from signal_generation import generate_signals, generate_rolling_signals, generate_rolling_stepwise_signals
...
config = {
    ...
    'end_date': '2025-07-01',
    'signal_method': 'rolling_stepwise',
    'rolling_window': 60,
    'step': 0.25
}
# ---- Run Walkforward ----
...
for res in results:
    ...
    if config.get('signal_method') == 'rolling_stepwise':
        signals = generate_rolling_stepwise_signals(
            spread_test,
    ...
    elif config.get('signal_method') == 'rolling':
